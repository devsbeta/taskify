...
class _AllTaskScreenState extends State<AllTaskScreen> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: context.read<PermissionsBloc>().iscreatetask == true
          ? Padding(
  ...
  Widget _taskAppbar() {
    return Padding(
        ...
        child: BackArrow(
          ...
          title: AppLocalizations.of(context)!.alltasks,
        ));
  }
