...
class _SeeAllTaskState extends State<SeeAllTask> {
  ...
  void initState() {
    todayTask();
    BlocProvider.of<TaskBloc>(context).add(TodaysTaskList(fromDate!, fromDate!));
  ...
  int _getFilterCount() {
    setState(() {
      if (projectSelectedIdS.isNotEmpty && projectSelectedIdS.length == 1) {
        filterCount++;
      }
      if (projectSelectedIdS.isEmpty) {
        filterCount--;
      }

      if (clientSelectedIdS.isNotEmpty && clientSelectedIdS.length == 1) {
        filterCount++;
      }
      ...
      if (userSelectedIdS.isNotEmpty && userSelectedIdS.length == 1) {
        filterCount++;
      ...
      if (statusSelectedIdS.isNotEmpty && statusSelectedIdS.length == 1) {
        filterCount++;
      }
      ...
      if (prioritySelectedIdS.isNotEmpty && prioritySelectedIdS.length == 1) {
        filterCount++;
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton:  context.read<PermissionsBloc>().iscreatetask == true ?Padding(
              ...
              Row(
                ...
                children: <Widget>[
                  Expanded(
                    ...
                    child: SizedBox(
                      // color: Colors.red,
                      height: 600, // Set a specific height if needed
  ...
  Widget _taskAppbar() {
    return Padding(
        ...
        child: BackArrow(
          ...
          iSBackArrow: true,
          fromDash: true,
          title: AppLocalizations.of(context)!.todaysTask,
        )
  ...
  Widget _dateList(isLightTheme) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
      Padding(
      padding:  EdgeInsets.symmetric(horizontal: 18.w),child:  DatePickerWidget(
  ...
  Widget searchField(isLightTheme) {
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
                  ...
                  child: Stack(children: [
                    ...
                    filterCount > 0
                      ...
                      child: Container(
                        ...
                        height: 12
                            .h, // Set equal height and width to make it a circle
                        width: 10.w,
                        decoration: BoxDecoration(
                          color: AppColors
            ...
            contentPadding: EdgeInsets.symmetric(
              vertical: (40.h - 20.sp) / 2, // Dynamically center vertically
              horizontal: 10.w, // Dynamic horizontal padding
            ),
  ...
  Widget _statusLists() {
    return BlocBuilder<StatusMultiBloc, StatusMultiState>(
        builder: (context, state) {
                            ...
                            onTap: () {
                              ...
                              setState(() {
                                if (isSelected) {
                                  ...
                                  statusSelectedname
                                      .remove(state.statusMulti[index].title!);
                                } else {
                                  if (!statusSelectedIdS
                                      .contains(state.statusMulti[index].id!)) {
                                    statusSelectedIdS
                                  ...
                                  filterSelectedId = state.statusMulti[index].id!;
                                  filterSelectedNmae = "status";
                                }
  ...
  Widget _priorityLists() {
    return BlocBuilder<PriorityMultiBloc, PriorityMultiState>(
        builder: (context, state) {
                              ...
                              setState(() {
                                ...
                                if (isSelected) {
                                  ...
                                  prioritySelectedname
                                      .remove(state.priorityMulti[index].title!);
                                } else {
  ...
  Widget _projectsLists() {
    return BlocBuilder<ProjectMultiBloc, ProjectMultiState>(
        builder: (context, state) {
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            task.description != null ?  SizedBox(
                              height: 8.h,
                            ):SizedBox.shrink(),
                            task.description != null ?  htmlWidget(task.description!,context,width:290.w,height: 36.h):SizedBox(
                              height: 40.h,
                              child: Align(
          ...
          onDismissed: (DismissDirection direction) async {
            if (direction == DismissDirection.endToStart &&
              ...
              setState(() {
                ...
                _onDeleteTask(task.users![index].id);
              });
            } else if (direction == DismissDirection.startToEnd &&
                context.read<PermissionsBloc>().iseditTask == true) {
              // Perform edit action
